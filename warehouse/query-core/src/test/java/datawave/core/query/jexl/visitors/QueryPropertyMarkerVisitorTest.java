...
public class QueryPropertyMarkerVisitorTest {
    ...
    public void testRegisteringMarkerWithoutOverriddenLabelMethod() {
        ...
        assertEquals("datawave.core.query.jexl.visitors.QueryPropertyMarkerVisitorTest$DoesNotOverrideLabelMethod.label()", throwable.getMessage());
    }
    ...
    public void testRegisteringMarkerWithEmptyLabel() {
        ...
        assertEquals("label() method must return a unique, non-empty label for type datawave.core.query.jexl.visitors.QueryPropertyMarkerVisitorTest$HasEmptyLabel",
    ...
    public void testRegisteringMarkerWithDuplicateLabel() {
        ...
        assertEquals("datawave.core.query.jexl.visitors.QueryPropertyMarkerVisitorTest$HasDuplicateLabel has the same label as org.apache.commons.jexl2.parser.ASTDelayedPredicate, labels must be unique",
                        throwable.getMessage());
    }
