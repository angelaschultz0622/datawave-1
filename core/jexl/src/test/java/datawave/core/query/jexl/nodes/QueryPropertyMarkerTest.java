...
public class QueryPropertyMarkerTest {
    ...
    public void testInstance_of() throws ParseException {
        ...
        JexlNode source = JexlASTHelper.parseJexlQuery("(FOO == 'a')");
    ...
    public void testInstance_isAnyType() throws ParseException {
        ...
        QueryPropertyMarker.Instance instance = QueryPropertyMarker.Instance.of(ASTDelayedPredicate.class, JexlASTHelper.parseJexlQuery("FOO == 'a'"));
    ...
    public void testInstance_isAnyTypeExcept() throws ParseException {
        QueryPropertyMarker.Instance instance = QueryPropertyMarker.Instance.of(ASTDelayedPredicate.class,
                        Lists.newArrayList(JexlASTHelper.parseJexlQuery("FOO == 'a'")));
    ...
    private QueryPropertyMarker.Instance findInstance(String query) throws ParseException {
        return QueryPropertyMarker.findInstance(query != null ? JexlASTHelper.parseJexlQuery(query) : null);
    }
